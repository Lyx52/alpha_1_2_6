...
public class x extends fy {
   ...
   public boolean a_(cy var1, int var2, int var3, int var4) {
      byte var5 = 0;
      byte var6 = 0;
      if(var1.a(var2 - 1, var3, var4) == nq.ap.bh || var1.a(var2 + 1, var3, var4) == nq.ap.bh) {
         var5 = 1;
      }

      if(var1.a(var2, var3, var4 - 1) == nq.ap.bh || var1.a(var2, var3, var4 + 1) == nq.ap.bh) {
         var6 = 1;
      }
      ...
      if(var5 == var6) {
         ...
         for(var7 = -1; var7 <= 2; ++var7) {
            for(var8 = -1; var8 <= 3; ++var8) {
               ...
               if(var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3) {
                  ...
                  } else if(var10 != 0 && var10 != nq.ar.bh) {
                     return false;
                  }
               }
            }
         ...
         for(var7 = 0; var7 < 2; ++var7) {
            for(var8 = 0; var8 < 3; ++var8) {
               var1.d(var2 + var5 * var7, var3 + var8, var4 + var6 * var7, nq.be.bh);
            }
         }
   ...
   public void a(cy var1, int var2, int var3, int var4, int var5) {
      ...
      if(var1.a(var2, var8 - 1, var4) != nq.ap.bh) {
         ...
         if(var9 == 3 && var1.a(var2, var8 + var9, var4) == nq.ap.bh) {
            ...
            if(var10 && var11) {
               var1.d(var2, var3, var4, 0);
            } else if((var1.a(var2 + var6, var3, var4 + var7) != nq.ap.bh || var1.a(var2 - var6, var3, var4 - var7) != this.bh) && (var1.a(var2 - var6, var3, var4 - var7) != nq.ap.bh || var1.a(var2 + var6, var3, var4 + var7) != this.bh)) {
               var1.d(var2, var3, var4, 0);
            }
         } else {
            var1.d(var2, var3, var4, 0);
