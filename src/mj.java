...
public class mj extends lh {
   ...
   private void h(cy var1, int var2, int var3, int var4) {
      ...
      byte var9 = 3;
      if(nq.o[var5] && !nq.o[var6]) {
         var9 = 3;
      }

      if(nq.o[var6] && !nq.o[var5]) {
         var9 = 2;
      }

      if(nq.o[var7] && !nq.o[var8]) {
         var9 = 5;
      }

      if(nq.o[var8] && !nq.o[var7]) {
         var9 = 4;
      }
   ...
   public int a(int var1) {
      return var1 == 1?nq.t.bh:(var1 == 0?nq.t.bh:(var1 == 3?this.bg - 1:this.bg));
   }
   ...
   public static void a(boolean var0, cy var1, int var2, int var3, int var4) {
      ...
      if(var0) {
         var1.d(var2, var3, var4, nq.aC.bh);
      } else {
         var1.d(var2, var3, var4, nq.aB.bh);
      }
