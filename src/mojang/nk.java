...
public class nk {
   ...
   public nk() {
      try {
         BufferedImage var1 = ImageIO.read(nk.class.getResource("/mojang/terrain.png"));
      ...
      for(int var15 = 0; var15 < 256; ++var15) {
         if(nq.m[var15] != null) {
            this.g[var15 * 3 + 0] = nq.m[var15].a(1);
            this.g[var15 * 3 + 1] = nq.m[var15].a(2);
            this.g[var15 * 3 + 2] = nq.m[var15].a(3);
         }
      }
               ...
               for(int var9 = var5 - 1; var9 >= var3; --var9) {
                  ...
                  for(int var14 = 0; var14 < 128; ++var14) {
                     ...
                     if(var15 < this.f[var12] || var15 < this.f[var12 + 1]) {
                        nq var16 = nq.m[var2.a(var9, var14, var8)];
                        if(var16 == null) {
                           var13 = false;
                        } else if(var16.bs == hb.f) {
                           int var17 = var2.a(var9, var14 + 1, var8);
                           if(var17 == 0 || nq.m[var17].bs != hb.f) {
                           ...
                           if(var15 >= -1 && var15 < 159) {
                              ...
                              var26 = this.g[var16.bh * 3 + 1];
                              var27 = var2.c(var9 - 1, var14, var8) * 0.8F + 0.2F;
                              int var21 = this.g[var16.bh * 3 + 2];
