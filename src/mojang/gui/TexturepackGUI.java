...
public class TexturepackGUI extends GraphicsUserInterface {
   ...
   public TexturepackGUI(GraphicsUserInterface interfaceRoot) {
      this.j = this.d - 55 + 4;
      this.l = 0;
      this.m = this.c;
      this.n = -2;
   ...
   public void initButtons() {
      ...
      this.minecraft.C.a();
      this.location = (new File(this.minecraft.D, "texturepacks")).getAbsolutePath();
      this.i = 32;
      this.j = this.d - 58 + 4;
      this.l = 0;
      this.m = this.c;
   ...
   protected void buttonClicked(Button var1) {
      if(var1.visible) {
         if(var1.value == 5) {
            Sys.openURL("file://" + this.location);
         }
   ...
   public void updateButtons(int var1, int var2, int var3) throws IOException {
      super.updateButtons(var1, var2, var3);
   }

   protected void updateCancelButtonState(int mx, int my, int mouseButton) {
      super.updateCancelButtonState(mx, my, mouseButton);
   }
   ...
   public void a(int var1, int var2, float var3) {
      ...
      if(Mouse.isButtonDown(0)) {
         if(this.n == -1) {
            if(var2 >= this.i && var2 <= this.j) {
               ...
               if(var1 >= var5 && var1 <= var6 && var7 >= 0 && var7 < var4.size() && this.minecraft.C.a((mojang.d)var4.get(var7))) {
                  this.minecraft.n.b();
               }
      ...
      GL11.glEnable(3008);
      GL11.glDisable(3042);
      this.displayButton(this.g, "Select Texture Pack", this.c / 2, 16, 16777215);
      this.displayButton(this.g, "(Place texture pack files here)", this.c / 2 - 77, this.d - 26, 8421504);
