...
public class dp extends lw {
   ...
   public dp(cy var1, double var2, double var4, double var6) {
      this(var1);
   ...
   public void e_() {
      ...
      if(this.as.z) {
         ...
         this.c(this.aC, this.aD);
         List var18 = this.as.b((lw)this, this.aG.b(0.20000000298023224D, 0.0D, 0.20000000298023224D));
         if(var18 != null && var18.size() > 0) {
            for(int var26 = 0; var26 < var18.size(); ++var26) {
               lw var20 = (lw)var18.get(var26);
               if(var20 != this.aq && var20.d_() && var20 instanceof dp) {
                  var20.g(this);
               }
            }
         }
