...
public abstract class ld extends nq {
   ...
   public static double a(pk var0, int var1, int var2, int var3, hb var4) {
      ao var5 = null;
      if(var4 == hb.f) {
         var5 = ((ld)nq.A).e(var0, var1, var2, var3);
      }

      if(var4 == hb.g) {
         var5 = ((ld)nq.C).e(var0, var1, var2, var3);
      }
      ...
      if(var1.a(var2, var3, var4) == this.bh) {
         if(this.bs == hb.g) {
            ...
            if(var5) {
               int var6 = var1.e(var2, var3, var4);
               if(var6 == 0) {
                  var1.d(var2, var3, var4, nq.ap.bh);
               } else if(var6 <= 4) {
                  var1.d(var2, var3, var4, nq.w.bh);
               }
