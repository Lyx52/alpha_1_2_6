...
public class nc {
   ...
   public nc(ew[] var1, int var2, int var3, int var4, int var5) {
      this(var1);
   ...
   public void a(is var1, float var2) {
      ao var3 = this.a[1].a.a(this.a[0].a);
      ao var4 = this.a[1].a.a(this.a[2].a);
      ao var5 = var4.b(var3).b();
      var1.b();
      if(this.c) {
