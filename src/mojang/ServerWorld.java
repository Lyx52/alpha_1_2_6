...
public class ServerWorld extends World {
   ...
   public ServerWorld(ib var1, long var2, int var4) throws IOException {
      super("MpServer", Dimension.a(var4), var2);
      this.B = var1;
      this.spawnX = 8;
      this.spawnY = 64;
      this.spawnZ = 8;
   ...
   public void b(int var1, int var2, int var3, ji var4) {
      if(!this.D) {
         this.B.a((BasePacket)(new py(var1, var2, var3, var4)));
      }
   }

   public void m() {
      this.B.a((BasePacket)(new qi("Quitting")));
   }
}
