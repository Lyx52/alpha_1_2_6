...
public class bk {
   ...
   public void a(nq var1, int var2, int var3, int var4, int var5) {
      this.b = var5;
      this.a(var1, var2, var3, var4);
      this.b = -1;
   }

   public boolean a(nq var1, int var2, int var3, int var4) {
      int var5 = var1.g();
   ...
   public boolean b(nq var1, int var2, int var3, int var4) {
      int var5 = this.a.e(var2, var3, var4);
      is var6 = is.a;
      float var7 = var1.d(this.a, var2, var3, var4);
      if(nq.s[var1.bh] > 0) {
         var7 = 1.0F;
      }
   ...
   public boolean c(nq var1, int var2, int var3, int var4) {
      int var5 = this.a.e(var2, var3, var4);
      int var6 = var5 & 7;
      ...
      float var13 = var1.d(this.a, var2, var3, var4);
      if(nq.s[var1.bh] > 0) {
         var13 = 1.0F;
      }
      ...
      float var23 = 0.0625F;
      float var24 = 0.625F;
      var21[0] = ao.b((double)(-var22), 0.0D, (double)(-var23));
      var21[1] = ao.b((double)var22, 0.0D, (double)(-var23));
      var21[2] = ao.b((double)var22, 0.0D, (double)var23);
      var21[3] = ao.b((double)(-var22), 0.0D, (double)var23);
      var21[4] = ao.b((double)(-var22), (double)var24, (double)(-var23));
      var21[5] = ao.b((double)var22, (double)var24, (double)(-var23));
      var21[6] = ao.b((double)var22, (double)var24, (double)var23);
      var21[7] = ao.b((double)(-var22), (double)var24, (double)var23);
   ...
   public boolean d(nq var1, int var2, int var3, int var4) {
      is var5 = is.a;
      int var6 = var1.a(0);
      if(this.b >= 0) {
         var6 = this.b;
      ...
      double var31;
      double var33;
      if(!this.a.g(var2, var3 - 1, var4) && !nq.ar.c(this.a, var2, var3 - 1, var4)) {
         float var37 = 0.2F;
         float var20 = 0.0625F;
         ...
         if(nq.ar.c(this.a, var2 - 1, var3, var4)) {
         ...
         if(nq.ar.c(this.a, var2, var3, var4 - 1)) {
         ...
         if(nq.ar.c(this.a, var2, var3 + 1, var4)) {
   ...
   public boolean e(nq var1, int var2, int var3, int var4) {
      is var5 = is.a;
      ...
      boolean var20 = lu.c(this.a, var2 - 1, var3, var4) || !this.a.g(var2 - 1, var3, var4) && lu.c(this.a, var2 - 1, var3 - 1, var4);
      boolean var21 = lu.c(this.a, var2 + 1, var3, var4) || !this.a.g(var2 + 1, var3, var4) && lu.c(this.a, var2 + 1, var3 - 1, var4);
      boolean var22 = lu.c(this.a, var2, var3, var4 - 1) || !this.a.g(var2, var3, var4 - 1) && lu.c(this.a, var2, var3 - 1, var4 - 1);
      boolean var23 = lu.c(this.a, var2, var3, var4 + 1) || !this.a.g(var2, var3, var4 + 1) && lu.c(this.a, var2, var3 - 1, var4 + 1);
      if(!this.a.g(var2, var3 + 1, var4)) {
         if(this.a.g(var2 - 1, var3, var4) && lu.c(this.a, var2 - 1, var3 + 1, var4)) {
            var20 = true;
         }
         ...
         if(this.a.g(var2, var3, var4 - 1) && lu.c(this.a, var2, var3 + 1, var4 - 1)) {
            var22 = true;
         }
      ...
      var16 = (double)(((float)var9 + 15.99F) / 256.0F);
      if(!this.a.g(var2, var3 + 1, var4)) {
         if(this.a.g(var2 - 1, var3, var4) && this.a.a(var2 - 1, var3 + 1, var4) == nq.av.bh) {
         ...
         if(this.a.g(var2, var3, var4 - 1) && this.a.a(var2, var3 + 1, var4 - 1) == nq.av.bh) {
   ...
   public boolean f(nq var1, int var2, int var3, int var4) {
      is var5 = is.a;
      ...
      float var8 = var1.d(this.a, var2, var3, var4);
   ...
   public boolean g(nq var1, int var2, int var3, int var4) {
      is var5 = is.a;
      int var6 = var1.a(0);
      if(this.b >= 0) {
         var6 = this.b;
   ...
   public boolean h(nq var1, int var2, int var3, int var4) {
      is var5 = is.a;
      float var6 = var1.d(this.a, var2, var3, var4);
      var5.a(var6, var6, var6);
      this.a(var1, this.a.e(var2, var3, var4), (double)var2, (double)var3, (double)var4);
      return true;
   }

   public boolean i(nq var1, int var2, int var3, int var4) {
      is var5 = is.a;
      float var6 = var1.d(this.a, var2, var3, var4);
      var5.a(var6, var6, var6);
   ...
   public void a(nq var1, double var2, double var4, double var6, double var8, double var10) {
      is var12 = is.a;
      int var13 = var1.a(0);
      if(this.b >= 0) {
         var13 = this.b;
   ...
   public void a(nq var1, int var2, double var3, double var5, double var7) {
      is var9 = is.a;
   ...
   public void b(nq var1, int var2, double var3, double var5, double var7) {
      is var9 = is.a;
      int var10 = var1.a(0, var2);
      if(this.b >= 0) {
         var10 = this.b;
   ...
   public boolean j(nq var1, int var2, int var3, int var4) {
      is var5 = is.a;
      boolean var6 = var1.b(this.a, var2, var3 + 1, var4, 1);
      boolean var7 = var1.b(this.a, var2, var3 - 1, var4, 0);
      boolean[] var8 = new boolean[]{var1.b(this.a, var2, var3, var4 - 1, 2), var1.b(this.a, var2, var3, var4 + 1, 3), var1.b(this.a, var2 - 1, var3, var4, 4), var1.b(this.a, var2 + 1, var3, var4, 5)};
      if(!var6 && !var7 && !var8[0] && !var8[1] && !var8[2] && !var8[3]) {
         ...
         if(this.d || var6) {
            ...
            float var25 = (float)ld.a(this.a, var2, var3, var4, var18);
            if(var25 > -999.0F) {
            ...
            var32 = fi.a(var25) * 8.0F / 256.0F;
            var33 = fi.b(var25) * 8.0F / 256.0F;
            var34 = var1.d(this.a, var2, var3, var4);
         ...
         if(this.d || var7) {
            float var48 = var1.d(this.a, var2, var3 - 1, var4);
         ...
         for(var24 = 0; var24 < 4; ++var24) {
            ...
            if(this.d || var8[var24]) {
               ...
               float var47 = var1.d(this.a, var49, var3, var27);
               if(var24 < 2) {
                  var47 *= var12;
               } else {
                  var47 *= var13;
   ...
   private float a(int var1, int var2, int var3, hb var4) {
      int var5 = 0;
      float var6 = 0.0F;
      ...
      for(int var7 = 0; var7 < 4; ++var7) {
         ...
         hb var11 = this.a.f(var8, var2, var10);
         if(var11 == var4) {
            int var12 = this.a.e(var8, var2, var10);
            if(var12 >= 8 || var12 == 0) {
               var6 += ld.b(var12) * 10.0F;
               var5 += 10;
            }
   ...
   public void a(nq var1, cy var2, int var3, int var4, int var5) {
      ...
      is var10 = is.a;
      var10.b();
      float var11 = var1.d((pk)var2, var3, var4, var5);
      float var12 = var1.d((pk)var2, var3, var4 - 1, var5);
      if(var12 < var11) {
         var12 = var11;
      }
      ...
      var12 = var1.d((pk)var2, var3, var4 + 1, var5);
      if(var12 < var11) {
         var12 = var11;
      }
      ...
      var12 = var1.d((pk)var2, var3, var4, var5 - 1);
      if(var12 < var11) {
         var12 = var11;
      }
      ...
      var12 = var1.d((pk)var2, var3 - 1, var4, var5);
      if(var12 < var11) {
         var12 = var11;
      }
   ...
   public boolean k(nq var1, int var2, int var3, int var4) {
      int var5 = var1.b(this.a, var2, var3, var4);
   ...
   public boolean a(nq var1, int var2, int var3, int var4, float var5, float var6, float var7) {
      is var8 = is.a;
      boolean var9 = false;
      float var10 = 0.5F;
      float var11 = 1.0F;
      ...
      float var26 = var1.d(this.a, var2, var3, var4);
      float var27;
      if(this.d || var1.b(this.a, var2, var3 - 1, var4, 0)) {
         var27 = var1.d(this.a, var2, var3 - 1, var4);
         var8.a(var17 * var27, var20 * var27, var23 * var27);
         this.a(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 0));
         var9 = true;
      }

      if(this.d || var1.b(this.a, var2, var3 + 1, var4, 1)) {
         var27 = var1.d(this.a, var2, var3 + 1, var4);
         if(var1.bo != 1.0D && !var1.bs.d()) {
            var27 = var26;
         }

         var8.a(var14 * var27, var15 * var27, var16 * var27);
         this.b(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 1));
         var9 = true;
      }

      if(this.d || var1.b(this.a, var2, var3, var4 - 1, 2)) {
         var27 = var1.d(this.a, var2, var3, var4 - 1);
         if(var1.bm > 0.0D) {
            var27 = var26;
         }

         var8.a(var18 * var27, var21 * var27, var24 * var27);
         this.c(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 2));
         var9 = true;
      }

      if(this.d || var1.b(this.a, var2, var3, var4 + 1, 3)) {
         var27 = var1.d(this.a, var2, var3, var4 + 1);
         if(var1.bp < 1.0D) {
            var27 = var26;
         }
      ...
      if(this.d || var1.b(this.a, var2 - 1, var3, var4, 4)) {
         var27 = var1.d(this.a, var2 - 1, var3, var4);
         if(var1.bk > 0.0D) {
            var27 = var26;
         }

         var8.a(var19 * var27, var22 * var27, var25 * var27);
         this.e(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 4));
         var9 = true;
      }

      if(this.d || var1.b(this.a, var2 + 1, var3, var4, 5)) {
         var27 = var1.d(this.a, var2 + 1, var3, var4);
         if(var1.bn < 1.0D) {
            var27 = var26;
         }
   ...
   public boolean l(nq var1, int var2, int var3, int var4) {
      int var5 = var1.b(this.a, var2, var3, var4);
      float var6 = (float)(var5 >> 16 & 255) / 255.0F;
      float var7 = (float)(var5 >> 8 & 255) / 255.0F;
      float var8 = (float)(var5 & 255) / 255.0F;
   ...
   public boolean b(nq var1, int var2, int var3, int var4, float var5, float var6, float var7) {
      is var8 = is.a;
      boolean var9 = false;
      float var10 = 0.5F;
      float var11 = 1.0F;
      ...
      float var25 = var13 * var7;
      float var26 = 0.0625F;
      float var27 = var1.d(this.a, var2, var3, var4);
      float var28;
      if(this.d || var1.b(this.a, var2, var3 - 1, var4, 0)) {
         var28 = var1.d(this.a, var2, var3 - 1, var4);
      ...
      if(this.d || var1.b(this.a, var2, var3, var4 - 1, 2)) {
         var28 = var1.d(this.a, var2, var3, var4 - 1);
         if(var1.bm > 0.0D) {
            var28 = var27;
         }
      ...
      if(this.d || var1.b(this.a, var2 - 1, var3, var4, 4)) {
         var28 = var1.d(this.a, var2 - 1, var3, var4);
         if(var1.bk > 0.0D) {
            var28 = var27;
         }
   ...
   public boolean m(nq var1, int var2, int var3, int var4) {
      boolean var5 = false;
      float var6 = 0.375F;
      float var7 = 0.625F;
      ...
      boolean var8 = false;
      boolean var9 = false;
      if(this.a.a(var2 - 1, var3, var4) == var1.bh || this.a.a(var2 + 1, var3, var4) == var1.bh) {
         var8 = true;
      }

      if(this.a.a(var2, var3, var4 - 1) == var1.bh || this.a.a(var2, var3, var4 + 1) == var1.bh) {
         var9 = true;
      }

      boolean var10 = this.a.a(var2 - 1, var3, var4) == var1.bh;
      boolean var11 = this.a.a(var2 + 1, var3, var4) == var1.bh;
      boolean var12 = this.a.a(var2, var3, var4 - 1) == var1.bh;
      boolean var13 = this.a.a(var2, var3, var4 + 1) == var1.bh;
      if(!var8 && !var9) {
         var8 = true;
      }
   ...
   public boolean n(nq var1, int var2, int var3, int var4) {
      boolean var5 = false;
      int var6 = this.a.e(var2, var3, var4);
      if(var6 == 0) {
   ...
   public boolean o(nq var1, int var2, int var3, int var4) {
      is var5 = is.a;
      gv var6 = (gv)var1;
      boolean var7 = false;
      float var8 = 0.5F;
      ...
      float var10 = 0.8F;
      float var11 = 0.6F;
      float var12 = var1.d(this.a, var2, var3, var4);
      float var13 = var1.d(this.a, var2, var3 - 1, var4);
      if(var6.bl > 0.0D) {
         var13 = var12;
      }
      ...
      this.a(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 0));
      var7 = true;
      var13 = var1.d(this.a, var2, var3 + 1, var4);
      if(var6.bo < 1.0D) {
         var13 = var12;
      }
      ...
      this.b(var1, (double)var2, (double)var3, (double)var4, var1.a(this.a, var2, var3, var4, 1));
      var7 = true;
      var13 = var1.d(this.a, var2, var3, var4 - 1);
      if(var6.bm > 0.0D) {
         var13 = var12;
      }
      ...
      var7 = true;
      this.c = false;
      var13 = var1.d(this.a, var2 - 1, var3, var4);
      if(var6.bk > 0.0D) {
         var13 = var12;
      }
   ...
   public void a(nq var1, double var2, double var4, double var6, int var8) {
      is var9 = is.a;
      if(this.b >= 0) {
         var8 = this.b;
      }
      ...
      int var10 = (var8 & 15) << 4;
      int var11 = var8 & 240;
      double var12 = ((double)var10 + var1.bk * 16.0D) / 256.0D;
      double var14 = ((double)var10 + var1.bn * 16.0D - 0.01D) / 256.0D;
      double var16 = ((double)var11 + var1.bm * 16.0D) / 256.0D;
      double var18 = ((double)var11 + var1.bp * 16.0D - 0.01D) / 256.0D;
      if(var1.bk < 0.0D || var1.bn > 1.0D) {
         var12 = (double)(((float)var10 + 0.0F) / 256.0F);
         var14 = (double)(((float)var10 + 15.99F) / 256.0F);
      }

      if(var1.bm < 0.0D || var1.bp > 1.0D) {
         var16 = (double)(((float)var11 + 0.0F) / 256.0F);
         var18 = (double)(((float)var11 + 15.99F) / 256.0F);
      }

      double var20 = var2 + var1.bk;
      double var22 = var2 + var1.bn;
      double var24 = var4 + var1.bl;
      double var26 = var6 + var1.bm;
      double var28 = var6 + var1.bp;
   ...
   public void b(nq var1, double var2, double var4, double var6, int var8) {
      is var9 = is.a;
      if(this.b >= 0) {
         var8 = this.b;
      }
   ...
   public void c(nq var1, double var2, double var4, double var6, int var8) {
      is var9 = is.a;
      if(this.b >= 0) {
         var8 = this.b;
      }
      ...
      double var12 = ((double)var10 + var1.bk * 16.0D) / 256.0D;
      double var14 = ((double)var10 + var1.bn * 16.0D - 0.01D) / 256.0D;
      double var16 = ((double)var11 + var1.bl * 16.0D) / 256.0D;
      double var18 = ((double)var11 + var1.bo * 16.0D - 0.01D) / 256.0D;
      double var20;
      if(this.c) {
         var20 = var12;
         var12 = var14;
      ...
      double var22 = var2 + var1.bn;
      double var24 = var4 + var1.bl;
      double var26 = var4 + var1.bo;
      double var28 = var6 + var1.bm;
   ...
   public void d(nq var1, double var2, double var4, double var6, int var8) {
      is var9 = is.a;
      if(this.b >= 0) {
         var8 = this.b;
      }
   ...
   public void e(nq var1, double var2, double var4, double var6, int var8) {
      is var9 = is.a;
      if(this.b >= 0) {
         var8 = this.b;
      }
      ...
      int var10 = (var8 & 15) << 4;
      int var11 = var8 & 240;
      double var12 = ((double)var10 + var1.bm * 16.0D) / 256.0D;
      double var14 = ((double)var10 + var1.bp * 16.0D - 0.01D) / 256.0D;
      double var16 = ((double)var11 + var1.bl * 16.0D) / 256.0D;
      double var18 = ((double)var11 + var1.bo * 16.0D - 0.01D) / 256.0D;
      double var20;
      if(this.c) {
   ...
   public void f(nq var1, double var2, double var4, double var6, int var8) {
      is var9 = is.a;
      if(this.b >= 0) {
         var8 = this.b;
      }
