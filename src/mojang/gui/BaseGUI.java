...
import mojang.*;
import mojang.gui.ChooseInputGUI;
import mojang.gui.GUIComponent;
import mojang.net.minecraft.client.Minecraft;
import org.lwjgl.input.Keyboard;
import org.lwjgl.opengl.GL11;

public class BaseGUI extends GUIComponent {
   ...
   public void a(float var1, boolean var2, int var3, int var4) {
      ...
      GL11.glBindTexture(3553, this.g.n.loadTexture("/mojang/assets/gui/gui.png"));
      fo var11 = this.g.playerName.e;
      this.k = -90.0F;
      this.b(var6 / 2 - 91, var7 - 22, 0, 0, 182, 22);
      this.b(var6 / 2 - 91 - 1 + var11.d * 20, var7 - 22 - 1, 0, 22, 24, 22);
      GL11.glBindTexture(3553, this.g.n.loadTexture("/mojang/assets/gui/icons.png"));
      GL11.glEnable(3042);
      ...
      byte var26 = 10;
      boolean var28 = false;
      if(this.g.p instanceof ChooseInputGUI) {
         var26 = 20;
         var28 = true;
      }
   ...
   private void a(int var1, int var2) {
      ...
      GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
      GL11.glDisable(3008);
      GL11.glBindTexture(3553, this.g.n.loadTexture("%blur%/misc/pumpkinblur.png"));
      is var3 = is.a;
      var3.b();
   ...
   private void a(float var1, int var2, int var3) {
      ...
      GL11.glBindTexture(3553, this.g.n.loadTexture("%blur%/misc/vignette.png"));
      is var4 = is.a;
      var4.b();
   ...
   private void b(float var1, int var2, int var3) {
      ...
      GL11.glBindTexture(3553, this.g.n.loadTexture("/mojang/terrain.png"));
