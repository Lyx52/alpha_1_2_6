...
public class nq {
   ...
   public static final Block BLOCK_STONE = new Block("stone", 1.0F, 1.0F);
   public static final Block BLOCK_WOOD = new Block("wood", 1.0F, 1.0F);
   public static final Block BLOCK_GRAVEL = new Block("gravel", 1.0F, 1.0F);
   public static final Block BLOCK_GRASS = new Block("grass", 1.0F, 1.0F);
   public static final Block h = new Block("stone", 1.0F, 1.0F);
   public static final Block i = new Block("stone", 1.0F, 1.5F);
   public static final Block j = new GlassBlock("stone", 1.0F, 1.0F);
   public static final Block k = new Block("cloth", 1.0F, 1.0F);
   public static final Block l = new GravelBlock("sand", 1.0F, 1.0F);
   ...
   public static final os u = (os)(new os(2)).c(0.6F).a(BLOCK_GRASS);
   public static final nq v = (new jf(3, 2)).c(0.5F).a(BLOCK_GRAVEL);
   public static final nq w = (new nq(4, 16, hb.d)).c(2.0F).b(10.0F).a(h);
   public static final nq x = (new nq(5, 4, hb.c)).c(2.0F).b(5.0F).a(BLOCK_WOOD);
   public static final nq y = (new ej(6, 15)).c(0.0F).a(BLOCK_GRASS);
   ...
   public static final nq F = (new ic(13, 19)).c(0.6F).a(BLOCK_GRAVEL);
   ...
   public static final nq J = (new ny(17)).c(2.0F).a(BLOCK_WOOD);
   public static final km K = (km)(new km(18, 52)).c(0.2F).d(1).a(BLOCK_GRASS);
   public static final nq L = (new pd(19)).c(0.6F).a(BLOCK_GRASS);
   ...
   public static final ok ad = (ok)(new ok(37, 13)).c(0.0F).a(BLOCK_GRASS);
   public static final ok ae = (ok)(new ok(38, 12)).c(0.0F).a(BLOCK_GRASS);
   public static final ok af = (ok)(new mr(39, 29)).c(0.0F).a(BLOCK_GRASS).a(0.125F);
   public static final ok ag = (ok)(new mr(40, 28)).c(0.0F).a(BLOCK_GRASS);
   ...
   public static final nq am = (new v(46, 8)).c(0.0F).a(BLOCK_GRASS);
   public static final nq an = (new eh(47, 35)).c(1.5F).a(BLOCK_WOOD);
   ...
   public static final nq aq = (new ob(50, 80)).c(0.0F).a(0.9375F).a(BLOCK_WOOD);
   public static final qh ar = (qh)((qh)(new qh(51, 31)).c(0.0F).a(1.0F).a(BLOCK_WOOD));
   public static final nq as = (new br(52, 65)).c(5.0F).a(i);
   public static final nq at = new mb(53, x);
   public static final nq au = (new c(54)).c(2.5F).a(BLOCK_WOOD);
   public static final nq av = (new lu(55, 84)).c(0.0F).a(BLOCK_STONE);
   public static final nq aw = (new hz(56, 50)).c(3.0F).b(5.0F).a(h);
   public static final nq ax = (new e(57, 40)).c(5.0F).b(10.0F).a(i);
   public static final nq ay = (new dd(58)).c(2.5F).a(BLOCK_WOOD);
   public static final nq az = (new ig(59, 88)).c(0.0F).a(BLOCK_GRASS);
   public static final nq aA = (new oa(60)).c(0.6F).a(BLOCK_GRAVEL);
   public static final nq aB = (new mj(61, false)).c(3.5F).a(h);
   public static final nq aC = (new mj(62, true)).c(3.5F).a(h).a(0.875F);
   public static final nq aD = (new ni(63, qc.class, true)).c(1.0F).a(BLOCK_WOOD);
   public static final nq aE = (new gv(64, hb.c)).c(3.0F).a(BLOCK_WOOD);
   public static final nq aF = (new ca(65, 83)).c(0.4F).a(BLOCK_WOOD);
   public static final nq aG = (new jn(66, 128)).c(0.7F).a(i);
   public static final nq aH = new mb(67, w);
   public static final nq aI = (new ni(68, qc.class, false)).c(1.0F).a(BLOCK_WOOD);
   public static final nq aJ = (new pl(69, 96)).c(0.5F).a(BLOCK_WOOD);
   public static final nq aK = (new ap(70, t.bg, EntityTypes.MOBS)).c(0.5F).a(h);
   public static final nq aL = (new gv(71, hb.e)).c(5.0F).a(i);
   public static final nq aM = (new ap(72, x.bg, EntityTypes.EVERYTHING)).c(0.5F).a(BLOCK_WOOD);
   ...
   public static final nq aP = (new bo(75, 115, false)).c(0.0F).a(BLOCK_WOOD);
   public static final nq aQ = (new bo(76, 99, true)).c(0.0F).a(0.5F).a(BLOCK_WOOD);
   ...
   public static final nq aW = (new lj(82, 72)).c(0.6F).a(BLOCK_GRAVEL);
   public static final nq aX = (new kz(83, 73)).c(0.0F).a(BLOCK_GRASS);
   public static final nq aY = (new dg(84, 74)).c(2.0F).b(10.0F).a(h);
   public static final nq aZ = (new gd(85, 4)).c(2.0F).b(5.0F).a(BLOCK_WOOD);
   public static final nq ba = (new cx(86, 102, false)).c(1.0F).a(BLOCK_WOOD);
   ...
   public static final nq bf = (new cx(91, 102, true)).c(1.0F).a(BLOCK_WOOD).a(1.0F);
   public int bg;
   public final int bh;
   protected float bi;
   protected float bj;
   ...
   static {
      for(int var0 = 0; var0 < 256; ++var0) {
         if(m[var0] != null) {
            Item.itemIds[var0] = new bc(var0 - 256);
         }
      }
