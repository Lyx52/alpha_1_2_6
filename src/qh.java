...
public class qh extends nq {
   ...
   public void a(cy var1, int var2, int var3, int var4, Random var5) {
      boolean var6 = var1.a(var2, var3 - 1, var4) == nq.bb.bh;
      ...
      } else if(!var6 && !this.c(var1, var2, var3 - 1, var4) && var7 == 15 && var5.nextInt(4) == 0) {
         var1.d(var2, var3, var4, 0);
      } else {
         if(var7 % 2 == 0 && var7 > 2) {
   ...
   private void a(cy var1, int var2, int var3, int var4, int var5, Random var6) {
      ...
      if(var6.nextInt(var5) < var7) {
         boolean var8 = var1.a(var2, var3, var4) == nq.am.bh;
         if(var6.nextInt(2) == 0) {
   ...
   private boolean h(cy var1, int var2, int var3, int var4) {
      return this.c(var1, var2 + 1, var3, var4)?true:(this.c(var1, var2 - 1, var3, var4)?true:(this.c(var1, var2, var3 - 1, var4)?true:(this.c(var1, var2, var3 + 1, var4)?true:(this.c(var1, var2, var3, var4 - 1)?true:this.c(var1, var2, var3, var4 + 1)))));
   }
   ...
   public void e(cy var1, int var2, int var3, int var4) {
      if(var1.a(var2, var3 - 1, var4) != nq.ap.bh || !nq.be.a_(var1, var2, var3, var4)) {
         if(!var1.g(var2, var3 - 1, var4) && !this.h(var1, var2, var3, var4)) {
            var1.d(var2, var3, var4, 0);
         } else {
            var1.h(var2, var3, var4, this.bh);
   ...
   public void b(cy var1, int var2, int var3, int var4, Random var5) {
      ...
      float var8;
      float var9;
      if(!var1.g(var2, var3 - 1, var4) && !nq.ar.c(var1, var2, var3 - 1, var4)) {
         if(nq.ar.c(var1, var2 - 1, var3, var4)) {
         ...
         if(nq.ar.c(var1, var2, var3, var4 - 1)) {
            for(var6 = 0; var6 < 2; ++var6) {
         ...
         if(nq.ar.c(var1, var2, var3 + 1, var4)) {
            for(var6 = 0; var6 < 2; ++var6) {
               var7 = (float)var2 + var5.nextFloat();
