...
public class dj extends GraphicsUserInterface {
   ...
   public dj() {
      try {
         ...
         BufferedReader var2 = new BufferedReader(new InputStreamReader(dj.class.getResourceAsStream("/mojang/title/splashes.txt")));
         String var3 = "";
   ...
   private void initButtons(float var1) {
      ...
      for(int var5 = 0; var5 < 3; ++var5) {
         ...
         GL11.glBindTexture(3553, this.b.n.a("/mojang/terrain.png"));
         if(var5 == 0) {
            GL11.glBindTexture(3553, this.b.n.a("/mojang/title/black.png"));
         }
