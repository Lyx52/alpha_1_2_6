...
public class MultiplayerGUI extends GraphicsUserInterface {
   ...
   public void initButtons() {
      ...
      this.i = this.b.y.lastServer.replaceAll("_", ":");
      ((Button)this.buttons.get(0)).g = this.i.length() > 0;
   }
   ...
   protected void a(Button var1) {
      if(var1.g) {
         if(var1.f == 1) {
            ...
            this.b.y.lastServer = this.i.replaceAll(":", "_");
            this.b.y.b();
            String[] var2 = this.i.split(":");
            this.b.a((GraphicsUserInterface)(new og(this.b, var2[0], var2.length > 1?this.a(var2[1], 25565):25565)));
         }
   ...
   protected void a(char var1, int var2) {
      ...
      if(var1 == 13) {
         this.a((Button)this.buttons.get(0));
      }
