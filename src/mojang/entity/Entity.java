...
public abstract class Entity {
   ...
   public boolean equals(Object var1) {
      return var1 instanceof Entity ?((Entity)var1).an == this.an:false;
   }
   ...
   public boolean c(CompoundTag var1) {
      String var2 = this.N();
   ...
   public void d(CompoundTag var1) {
      var1.putBaseTag("Pos", (BaseTag)this.a(new double[]{this.aw, this.ax, this.ay}));
      var1.putBaseTag("Motion", (BaseTag)this.a(new double[]{this.az, this.aA, this.aB}));
      var1.putBaseTag("Rotation", (BaseTag)this.a(new float[]{this.aC, this.aD}));
      var1.putFloatTag("FallDistance", this.aU);
      var1.putShortTag("Fire", (short)this.bg);
      var1.putShortTag("Air", (short)this.bk);
      var1.putBooleanTag("OnGround", this.aH);
      this.a(var1);
   }

   public void e(CompoundTag var1) {
      ListTag var2 = var1.getListTag("Pos");
      ListTag var3 = var1.getListTag("Motion");
      ListTag var4 = var1.getListTag("Rotation");
      this.b(0.0D, 0.0D, 0.0D);
      this.az = ((DoubleTag)var3.a(0)).value;
      this.aA = ((DoubleTag)var3.a(1)).value;
      this.aB = ((DoubleTag)var3.a(2)).value;
      this.at = this.aV = this.aw = ((DoubleTag)var2.a(0)).value;
      this.au = this.aW = this.ax = ((DoubleTag)var2.a(1)).value;
      this.av = this.aX = this.ay = ((DoubleTag)var2.a(2)).value;
      this.aE = this.aC = ((FloatTag)var4.a(0)).value;
      this.aF = this.aD = ((FloatTag)var4.a(1)).value;
      this.aU = var1.getFloat("FallDistance");
      this.bg = var1.getShort("Fire");
      this.bk = var1.getShort("Air");
      this.aH = var1.getBoolean("OnGround");
      this.b(this.aw, this.ax, this.ay);
      this.b(var1);
   }
   ...
   protected abstract void b(CompoundTag var1);

   protected abstract void a(CompoundTag var1);
   ...
   protected ListTag a(double ... var1) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         var2.a((BaseTag)(new DoubleTag(var6)));
      }
   ...
   protected ListTag a(float ... var1) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         var2.a((BaseTag)(new FloatTag(var6)));
      }
   ...
   public DroppedItem b(int var1, int var2) {
      return this.a(var1, var2, 0.0F);
   }

   public DroppedItem a(int var1, int var2, float var3) {
      DroppedItem var4 = new DroppedItem(this.as, this.aw, this.ax + (double)var3, this.ay, new fp(var1, var2));
      var4.c = 10;
