...
public class DroppedItem extends Entity {
   ...
   public void a(CompoundTag var1) {
      var1.putShortTag("Health", (short)((byte)this.f));
      var1.putShortTag("Age", (short)this.b);
      var1.putCompoundTag("Item", this.a.a(new CompoundTag()));
   }

   public void b(CompoundTag var1) {
      this.f = var1.getShort("Health") & 255;
      this.b = var1.getShort("Age");
      CompoundTag var2 = var1.getMapTag("Item");
      this.a = new fp(var2);
   }
