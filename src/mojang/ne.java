...
public class ne extends ex {
   ...
   protected void a(float var1) {
      int var2 = this.minecraft.n.loadTexture("/mojang/assets/gui/inventory.png");
      ...
      float var6 = this.minecraft.playerName.s;
      float var7 = this.minecraft.playerName.aC;
      float var8 = this.minecraft.playerName.aD;
      ...
      this.minecraft.playerName.s = (float)Math.atan((double)(var9 / 40.0F)) * 20.0F;
      this.minecraft.playerName.aC = (float)Math.atan((double)(var9 / 40.0F)) * 40.0F;
      this.minecraft.playerName.aD = -((float)Math.atan((double)(var10 / 40.0F))) * 20.0F;
      GL11.glTranslatef(0.0F, this.minecraft.playerName.aO, 0.0F);
      mn.a.a(this.minecraft.playerName, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F);
      this.minecraft.playerName.s = var6;
      this.minecraft.playerName.aC = var7;
      this.minecraft.playerName.aD = var8;
      GL11.glPopMatrix();
      mojang.l.a();
      GL11.glDisable('\u803a');
   }
