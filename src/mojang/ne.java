...
public class ne extends ex {
   ...
   protected void a(float var1) {
      ...
      float var6 = this.b.g.s;
      float var7 = this.b.g.aC;
      float var8 = this.b.g.aD;
      ...
      this.b.g.s = (float)Math.atan((double)(var9 / 40.0F)) * 20.0F;
      this.b.g.aC = (float)Math.atan((double)(var9 / 40.0F)) * 40.0F;
      this.b.g.aD = -((float)Math.atan((double)(var10 / 40.0F))) * 20.0F;
      GL11.glTranslatef(0.0F, this.b.g.aO, 0.0F);
      mn.a.a(this.b.g, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F);
      this.b.g.s = var6;
      this.b.g.aC = var7;
      this.b.g.aD = var8;
      GL11.glPopMatrix();
