...
public class Arrow extends Entity {
   ...
   public void e_() throws IOException {
      ...
      mojang.ao var16 = mojang.ao.b(this.aw, this.ax, this.ay);
   ...
   public void a(CompoundTag var1) {
      var1.putShortTag("xTile", (short)this.c);
      var1.putShortTag("yTile", (short)this.d);
      var1.putShortTag("zTile", (short)this.e);
      var1.putByteTag("inTile", (byte)this.f);
      var1.putByteTag("shake", (byte)this.a);
      var1.putByteTag("inGround", (byte)(this.g?1:0));
   }
   ...
   public void b(CompoundTag var1) {
      ...
      this.f = var1.getByte("inTile") & 255;
      this.a = var1.getByte("shake") & 255;
      this.g = var1.getByte("inGround") == 1;
   }
