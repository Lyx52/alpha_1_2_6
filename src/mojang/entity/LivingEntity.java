...
public class LivingEntity extends Entity {
   ...
   public boolean d(Entity var1) {
      return this.as.a(mojang.ao.b(this.aw, this.ax + (double)this.v(), this.ay), mojang.ao.b(var1.aw, var1.ax + (double)var1.v(), var1.ay)) == null;
   }
   ...
   public void a(CompoundTag var1) {
      var1.putShortTag("Health", (short)this.J);
      var1.putShortTag("HurtTime", (short)this.L);
      var1.putShortTag("DeathTime", (short)this.O);
      var1.putShortTag("AttackTime", (short)this.P);
   }

   public void b(CompoundTag var1) {
      this.J = var1.getShort("Health");
      if(!var1.hasKey("Health")) {
         this.J = 10;
      }

      this.L = var1.getShort("HurtTime");
      this.O = var1.getShort("DeathTime");
      this.P = var1.getShort("AttackTime");
   }
   ...
   public void k() throws IOException {
      ...
      List var10 = this.as.b((Entity)this, this.aG.b(0.20000000298023224D, 0.0D, 0.20000000298023224D));
   ...
   public void b(Entity var1, float var2) {
      ...
      if(var1 instanceof LivingEntity) {
         LivingEntity var9 = (LivingEntity)var1;
   ...
   public boolean a() {
      return this.as.a(this.aG) && this.as.a((Entity)this, this.aG).size() == 0 && !this.as.b(this.aG);
   }
   ...
   public ao e(float var1) {
      if(var1 == 1.0F) {
         return mojang.ao.b(this.aw, this.ax, this.ay);
      } else {
         ...
         return mojang.ao.b(var2, var4, var6);
      }
   }
   ...
   public ao f(float var1) {
      ...
      if(var1 == 1.0F) {
         ...
         return mojang.ao.b((double)(var3 * var4), (double)var5, (double)(var2 * var4));
      } else {
         ...
         return mojang.ao.b((double)(var5 * var6), (double)var7, (double)(var4 * var6));
      }
   }
