...
public class at extends lw {
   ...
   public at(cy var1, double var2, double var4, double var6) {
      super(var1);
      this.h = 0;
      this.a(0.25F, 0.25F);
   ...
   public void e_() {
      ...
      ao var15 = ao.b(this.aw, this.ax, this.ay);
      ao var2 = ao.b(this.aw + this.az, this.ax + this.aA, this.ay + this.aB);
      nx var3 = this.as.a(var15, var2);
      var15 = ao.b(this.aw, this.ax, this.ay);
      var2 = ao.b(this.aw + this.az, this.ax + this.aA, this.ay + this.aB);
      if(var3 != null) {
         var2 = ao.b(var3.f.a, var3.f.b, var3.f.c);
      }
