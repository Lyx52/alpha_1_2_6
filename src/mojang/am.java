...
public class am extends ot implements cz {
   ...
   protected void b_() {
      ...
      if(this.g != null && this.g.f(this) < var9 * var9) {
         ...
         if(this.d(this.g)) {
            ...
            if(this.f == 20) {
               ...
               az var17 = new az(this.as, this, var11, var13, var15);
               double var18 = 4.0D;
               ao var20 = this.f(1.0F);
      ...
      this.z = this.f > 10? "/mojang/mob/ghast_fire.png" : "/mojang/mob/ghast.png";
   }
   ...
   private boolean a(double var1, double var3, double var5, double var7) {
      ...
      for(int var16 = 1; (double)var16 < var7; ++var16) {
         ...
         if(this.as.a((lw)this, var15).size() > 0) {
            return false;
         }
      }
