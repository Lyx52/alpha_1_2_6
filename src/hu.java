...
public class hu implements pu {
   ...
   public void c(String var1) {
      if(!this.b.H) {
         ...
         this.c = var1;
         kl var2 = new kl(this.b.c, this.b.d);
         int var3 = var2.a();
         int var4 = var2.b();
         GL11.glClear(256);
   ...
   public void a(int var1) {
      if(!this.b.H) {
         ...
         if(var2 - this.d >= 20L) {
            this.d = var2;
            kl var4 = new kl(this.b.c, this.b.d);
            int var5 = var4.a();
            int var6 = var4.b();
            GL11.glClear(256);
            GL11.glMatrixMode(5889);
            ...
            GL11.glClear(16640);
            is var7 = is.a;
            int var8 = this.b.n.a("/gui/background.png");
