...
class oc {
   ...
   private void b() {
      for(int var1 = 0; var1 < this.g.size(); ++var1) {
         oc var2 = this.a((on)this.g.get(var1));
         if(var2 != null && var2.b(this)) {
            this.g.set(var1, new on(var2.c, var2.d, var2.e));
         } else {
            this.g.remove(var1--);
         }
      }
   ...
   private oc a(on var1) {
      return this.b.a(var1.a, var1.b, var1.c) == this.a.bh?new oc(this.a, this.b, var1.a, var1.b, var1.c):(this.b.a(var1.a, var1.b + 1, var1.c) == this.a.bh?new oc(this.a, this.b, var1.a, var1.b + 1, var1.c):(this.b.a(var1.a, var1.b - 1, var1.c) == this.a.bh?new oc(this.a, this.b, var1.a, var1.b - 1, var1.c):null));
   }

   private boolean b(oc var1) {
      for(int var2 = 0; var2 < this.g.size(); ++var2) {
         on var3 = (on)this.g.get(var2);
   ...
   private boolean c(oc var1) {
      if(this.b(var1)) {
         ...
         on var2 = (on)this.g.get(0);
         return var1.d == this.d && var2.b == this.d?true:true;
      }
   }

   private void d(oc var1) {
      this.g.add(new on(var1.c, var1.d, var1.e));
   ...
   private boolean c(int var1, int var2, int var3) {
      oc var4 = this.a(new on(var1, var2, var3));
      if(var4 == null) {
         return false;
      } else {
         var4.b();
   ...
   public void a(boolean var1) {
      ...
      for(int var7 = 0; var7 < this.g.size(); ++var7) {
         oc var8 = this.a((on)this.g.get(var7));
         if(var8 != null) {
            var8.b();
            if(var8.c(this)) {
               var8.d(this);
