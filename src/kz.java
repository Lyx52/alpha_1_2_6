...
public class kz extends nq {
   ...
   public boolean a(cy var1, int var2, int var3, int var4) {
      ...
      return var5 == this.bh?true:(var5 != nq.u.bh && var5 != nq.v.bh?false:(var1.f(var2 - 1, var3 - 1, var4) == hb.f?true:(var1.f(var2 + 1, var3 - 1, var4) == hb.f?true:(var1.f(var2, var3 - 1, var4 - 1) == hb.f?true:var1.f(var2, var3 - 1, var4 + 1) == hb.f))));
   }
