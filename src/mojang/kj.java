...
public class kj implements bd {
   ...
   public void b(int var1, int var2, byte[] var3) {
      ...
      for(int var7 = 0; var7 < 16; ++var7) {
         for(int var8 = 0; var8 < 16; ++var8) {
            ...
            int var12 = -1;
            byte var13 = (byte)nq.bb.bh;
            byte var14 = (byte)nq.bb.bh;

            for(int var15 = 127; var15 >= 0; --var15) {
               int var16 = (var7 * 16 + var8) * 128 + var15;
               if(var15 >= 127 - this.h.nextInt(5)) {
                  var3[var16] = (byte)nq.z.bh;
   ...
   public ha b(int var1, int var2) {
      ...
      ha var4 = new ha(this.n, var3, var1, var2);
      var4.c();
      var4.d();
      return var4;
   }
   ...
   public void a(bd var1, int var2, int var3) {
      ...
      for(var6 = 0; var6 < 8; ++var6) {
         ...
         (new kf(nq.C.bh)).a(this.n, this.h, var7, var8, var9);
      }
      ...
      for(var7 = 0; var7 < var6; ++var7) {
         ...
         (new pm()).a(this.n, this.h, var8, var9, var10);
      }
      ...
      for(var7 = 0; var7 < var6; ++var7) {
         ...
         var9 = this.h.nextInt(120) + 4;
         var10 = var5 + this.h.nextInt(16) + 8;
         (new dt()).a(this.n, this.h, var8, var9, var10);
      }
      ...
      for(var7 = 0; var7 < 10; ++var7) {
         ...
         var10 = var5 + this.h.nextInt(16) + 8;
         (new lp()).a(this.n, this.h, var8, var9, var10);
      }
      ...
      if(this.h.nextInt(1) == 0) {
         ...
         var9 = var5 + this.h.nextInt(16) + 8;
         (new aj(nq.af.bh)).a(this.n, this.h, var7, var8, var9);
      }
      ...
      if(this.h.nextInt(1) == 0) {
         ...
         var8 = this.h.nextInt(128);
         var9 = var5 + this.h.nextInt(16) + 8;
         (new aj(nq.ag.bh)).a(this.n, this.h, var7, var8, var9);
      }
