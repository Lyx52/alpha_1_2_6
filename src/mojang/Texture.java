...
public class Texture {
   ...
   private OptionsManager h;
   private boolean i = false;
   private boolean j = false;
   private ff k;


   public Texture(ff var1, OptionsManager var2) {
      this.k = var1;
      this.h = var2;
   }
   ...
   public int loadTexture(String location) {
      d var2 = this.k.a;
      Integer var3 = (Integer)this.b.get(location);
      if(var3 != null) {
         ...
         try {
            ...
            if(location.startsWith("##")) {
               this.a(this.b(this.a(var2.a(location.substring(2)))), var5);
            } else if(location.startsWith("%clamp%")) {
               this.i = true;
               this.a(this.a(var2.a(location.substring(7))), var5);
               this.i = false;
            } else if(location.startsWith("%blur%")) {
               this.j = true;
               this.a(this.a(var2.a(location.substring(6))), var5);
               this.j = false;
            } else {
               this.a(this.a(var2.a(location)), var5);
            }

            this.b.put(location, Integer.valueOf(var5));
            return var5;
   ...
   public int a(String var1, String var2) {
      ...
      return var3 != null && var3.c >= 0?var3.c:this.loadTexture(var2);
   }
